  ...
  return (
    ...
    <nav className="flex justify-between items-center">
      ...
      <ul className="inline-flex gap-[50px]">
        ...
        <li><Link to="/Register"><button className="text-xl bg-gradient-to-r from-blue-500 to-pink-500 brightness-125 rounded px-3 hover:brightness-100 cursor-pointer font-bold">Register</button></Link></li>
      </ul>
    </nav>
    <section className="max-w-none">
      <h1 className="text-6xl text-left mb-2 font-extrabold">Mentor Matching</h1>
